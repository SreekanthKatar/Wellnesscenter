...
public class HomePage_Locators 
{
		...
		//Click Here to Login Xpath
		public String Click_here_to_Login_button_xpath = "/html/body/div/div[2]/div[3]/div[2]/a/img";
		
	
		//Click Here to Login Class Name
		public String Click_here_to_Login_ClassName = "clickheretext";
